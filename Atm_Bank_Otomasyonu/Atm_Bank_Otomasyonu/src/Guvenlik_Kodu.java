...
public class Guvenlik_Kodu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lütfen Sistem Girişi için Tuşları Kullanın", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jLabel1.setText("ATM Bankacılığı Güvenlik Kodu Almak İçin Tıklayın");
    ...
    String ilk = "", son = ""; //Globalde boş iki değişken tanımladım
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        jLabel1.setVisible(false);//mouse ile  tıklandığı zaman labelin görünürlüğünü kapattık 
        int sayılar[] = {1, 2, 3, 4, 5, 6, 7, 8, 9, 0};
//10 elemalı sayılar dizisi oluşturduk dongü sayesinde rast gele 
//bir indisi seçecek indisteki degeri kod değişkenine ekleyecek  

        for (int i = 0; i < 5; i++) {
            kod += String.valueOf(sayılar[(int) (Math.random() * 10)]);
        }
        tm.start();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (jTextField1.getText().equals("")) {
            ...
            if (kod.equals(jTextField1.getText())) {
                ...
                JOptionPane.showMessageDialog(null, "Koğrulama Kodu Hatalı..", "Uyarı", HEIGHT);
                jTextField1.setText("");
            }
    ...
    private void jTextField1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField1MouseClicked
        // JOptionPane.showMessageDialog(null, "Güvenlik Kodunu Girmek için Tuş Takımını Kullanın..");
