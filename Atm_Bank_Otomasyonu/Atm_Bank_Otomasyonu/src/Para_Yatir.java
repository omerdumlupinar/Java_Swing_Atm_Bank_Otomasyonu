...
public class Para_Yatir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Yazi.setText("Lütfen Yatırmak İstediğiniz Turarı Giriniz");
    ...
    public void islem_ekle_ve_para_ekle() {
        ...
        try {
            ...
            if (Integer.parseInt(jLabel_bakiye.getText()) > 6000 || arapara > 6000) {
                ...
                JOptionPane.showMessageDialog(null, "Hesabınıza " + toplam + " TL Yatırılmıştır.", "Bilgi", ICONIFIED);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (Integer.parseInt(jLabel_on.getText()) >= 100) {
            JOptionPane.showMessageDialog(null, "10'lük Limiti Doldu", "Bilgi", ICONIFIED);
            jButton6.setEnabled(false);
        } else {
