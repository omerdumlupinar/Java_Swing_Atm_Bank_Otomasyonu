...
public class Havale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Yazi.setText("Havale Tutarı");
        ...
        jLabel_Yazi2.setText("Alıcı Hesap No");
    ...
    public void bilgilistele() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Veri Tabanı Bağlantısında Bir Hata Oluştu Kontol Ederek Tekrar Deneyin", "Uyarı", HEIGHT);
        }
    }
    ...
    public void islem_ekle_ve_para_ekle() throws SQLException {
        ...
        try {
            if (is.havale_bakiye + gonderilecekToplamPara > 6000) {
                ...
                JOptionPane.showMessageDialog(null, "Hesabınızadan\n" + jTextField_hesapNo.getText() + " Nolu Hesaba\n" + gonderilecekToplamPara + " TL Havale Gerçekleşmiştir.", "Bilgi", ICONIFIED);
                jTextField1.setText("0");

                //GÖNDEREN BANKNOT GÜNCELLEME
                is.banknot_ekle(
                    ...
                    if (jLabel_BankaAdi.getText().equals(is.Havale_Banka_Adi)) {
                        ...
                        if (!jTextField_hesapNo.getText().equals(jLabel_hesapNo.getText())) {
                            ...
                            if (is.Havale_hesap_Kontrol(Integer.parseInt(jTextField_hesapNo.getText()))) {
                                ...
                                JOptionPane.showMessageDialog(null, "Bankanızda Böyle Bir Hesap Numarası Bulunmamakatadır EFT Menüsüne Gidiniz...", "Uyarı", HEIGHT);
                            }
                        } else {
                            JOptionPane.showMessageDialog(null, "Kendi Hesabınıza Havale Yapamassınız.", "Uyarı", HEIGHT);
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Banka Uyuşmuyor Hesap Numarasını Kontol Ederek Tekrar Deneyin.", "Uyarı", HEIGHT);
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Lütfen Hesap Numarası Giriniz...", "Uyarı", HEIGHT);
                }
            } else {
