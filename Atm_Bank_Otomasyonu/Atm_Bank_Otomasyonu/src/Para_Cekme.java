...
public class Para_Cekme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Yazi.setText("Lütfen Çekmek İstediğiniz Turarı Giriniz");
    ...
    public void bilgilistele() {
        ...
        try {
            ...
            //jLabel_bakiye.setText(String.valueOf(is.bakiye));
            jLabel_bakiye.setText(String.valueOf(para()));
            jLabel_BankaAdi.setText(String.valueOf(is.bankaAd));

            ImageIcon kadin = new ImageIcon("../atmDemo/foto/avatar2.png");
            //ImageIcon erkek = new ImageIcon("../foto/Avatar_Erkek.png");
    ...
    public void islem_ekle_ve_para_ekle() {
        ...
        try {
            ...
            if (Integer.parseInt(jLabel_bakiye.getText()) > 6000 || arapara > 6000) {
                JOptionPane.showMessageDialog(null, "Yüklediğiniz Miktar hesap Limitini Aşıyor Toplam Limit 6000TL Olmalı...", "Uyarı", HEIGHT);
            } else {
                ...
                JOptionPane.showMessageDialog(null, "Hesabınıza " + toplam + " TL para çekilmiştir.", "Bilgi", ICONIFIED);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField1.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "İlgili Alan Boş Geçilemez...", "Uyarı", HEIGHT);
        } else {
            try {
                ...
                if (deger != 0) {
                    if (deger % 5 == 0) {
                        ...
                        JOptionPane.showMessageDialog(null, "5'in Katlarını Griniz...", "Uyarı", HEIGHT);
                    }
                } else {
